...
\begin{pgfmanualentry}
  \extractcommand\robExtPlaceholderRemoveSpacesUntil\marg{placeholder}\opt{\oarg{nb of additional letters to remove}}\marg{separator}\@@
  \makeatletter%
  \def\extrakeytext{style, }
...
\begin{pgfmanualentry}
  \extractcommand\robExtPlaceholderPrependAllLines\marg{placeholder}\marg{text}\@@
  \makeatletter%
  \def\extrakeytext{style, }
...
\begin{PlaceholderFromCode}{__TMP__}
  ...
  >>>     return 48
\end{PlaceholderFromCode}
\robExtPlaceholderRemoveSpacesUntil{__TMP__}{>>>}
\robExtPlaceholderPrependAllLines{__TMP__}{My text\space\space\space\space}

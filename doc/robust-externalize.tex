...
will produce the image visible in \cref{fig:pythonGeneratedImage}. Note that if you use a version before 2.6, you cannot indent the python code (i.e.
the first line must not start with any space).
\begin{figure}
\centering
\begin{CacheMeCode}{python, set includegraphics options={width=.8\linewidth}}
    import matplotlib.pyplot as plt

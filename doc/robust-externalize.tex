...
\begin{center}
  ...
  \vspace{1em}
  {Léo Colisson \quad Version 2.4+unstable}\\[3mm]
...
You need to provide your own style file, say |new_zxstyle.tikzstyles| We provide out 
...
\begin{itemize}
\item v2.5 (current master, not yet published):
  \begin{itemize}

...
\begin{pgfmanualentry}
  ...
  \extractcommand\robExtGpgetvarNb\opt{\oarg{text, default 404}}\marg{variable name}\@@
  \pgfmanualbody
...
\end{codeAndResult}
|\robExtGpgetvarNb| is similar, except that it prints a number 404 by default (useful if you use it in siunit). You can choose another text using the optional argument.
\end{pgfmanualentry}

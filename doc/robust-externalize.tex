...
\begin{codeexample}[width=0pt,vbox]
  ...
  \begin{tikzpictureC}[baseline=(A.base)][add to preamble={\usepackage{pifont}}]
...
Since |CacheMe| is more general as it applies also to non-tikz pictures (just replace |tikz| with the style of your choice), we will use this syntax from now.
...
%         \verbatiminput{\robExtAddCachePathAndName{\robExtFinalName.codeonly.py}}
%         \includegraphics[width=.6\textwidth]{\robExtAddCachePathAndName{\robExtFinalName.pdf}}%
%         \caption{\mycaption}
%       \end{figure}
%     },
%   },
...
\subsection{Maintaining a clean cache}
